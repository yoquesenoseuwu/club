 ...
 */
public class ID_nominas extends javax.swing.JFrame {

    /**
     * Creates new form ID_nominas
     */
    public ID_nominas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ID_nominas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ID_nominas().setVisible(true);
            }
        });
    }
