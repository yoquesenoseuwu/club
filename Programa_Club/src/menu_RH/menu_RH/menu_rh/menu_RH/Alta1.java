...
public class Alta1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel11.setFont(new java.awt.Font("Waree", 0, 15)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(229, 232, 236));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(3, 3, 3)
                                        .addComponent(ing_edad, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(23, 23, 23)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(46, 46, 46)))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(nro_documen, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
        ...
        jLabel11.getAccessibleContext().setAccessibleName("Cargo_elegido");
    ...
    private void ingre_mailActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void ingre_telActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         
    ...
    private void cargarCargos() {
        ...
        try {
            ...
            // Consulta para obtener los nombres de los cargos
            String sql = "SELECT nombre_cargo FROM Cargo"; // Asegúrate de que este es el nombre correcto de la columna
            resultSet = statement.executeQuery(sql); // Inicialización de resultSet

            // Limpiar el JComboBox antes de agregar nuevos elementos
            jComboBox1.removeAllItems();

            // Iterar sobre los resultados y agregar cada nombre de cargo al JComboBox
            while (resultSet.next()) {
                String nombreCargo = resultSet.getString("nombre_cargo");
                jComboBox1.addItem(nombreCargo);
            }
            ...
            // Cerrar los recursos
            try {
                if (resultSet != null) resultSet.close(); // Cierre de resultSet
                if (statement != null) statement.close(); // Cierre de statement
                if (connection != null) connection.close(); // Cierre de connection
    ...
    private void ingre_telKeyTyped(java.awt.event.KeyEvent evt) {                                   
